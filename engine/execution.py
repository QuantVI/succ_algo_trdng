...
class ExecutionHandler(object):
    """
    The ExecutionHandler abstratc class handles the interaction between
    a set of order objects generated by a Portfolio and the ultimate set
    of Fill objects that actually occurs in the market.

    The handlers can be used to subclass simulated brokerages or
    live brokerages, with identical interfaces. This allows strategies
    to be backtested in a very similar manner to the live trading engine.
    """
...
class SimulatedExecutionHandler(ExecutionHandler):
    ...
    def execute_order(self, event):
        """
        Simply converts Order objects into Fill objects naively, i.e.
        without any latency, slippage of fill ratio problems.

        Parameters:
        event - ontains an Event object with order information.
        """
        if event.type == 'ORDER':
