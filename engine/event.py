...
class OrderEvent(Event):
    ...
    def __init__(self, symbol, order_type, quantity, direction):
        ...
        order_type - 'MKT' or 'LMT' for Market to Limit.
    ...
    def print_order(self):
        ...
        """
        print("Order: Symbol={}, Type={}, Quantitity={}, Direction={}" \
...
class FillEvent(Event):
    ...
    def __init__(self, timeindex, symbol, exchange, quantity, direction,
        ...
        quantity, direction, cost of fill and optional commission.

        If commission is not provided, the Fill object will calculate it
        based on the trade size and Interactive Brokers fees.
    ...
    def calculate_ib_commission(self):
        ...
        This does not include exchange of ECN fees.
